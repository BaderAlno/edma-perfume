                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
                    {tTest.items.map((testimonial, idx) => (
                        <motion.div
                            ...
                            className="bg-white/5 backdrop-blur-sm border border-[#D4AF37]/20 rounded-2xl p-8 flex flex-col gap-6 relative group hover:bg-white/10 hover:border-[#D4AF37]/40 transition-all duration-500"
                        >
